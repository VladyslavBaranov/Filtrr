...
final class SettingsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var restoreActivityIndicator: UIActivityIndicatorView!
    ...
    override func viewDidLoad() {
        ...
        if !StoreObserver.shared.isSubscribed() {
            ...
            settingsItems.removeAll { $0.type == .restore }
        }
        setupToolBar()
        ...
        restoreActivityIndicator = UIActivityIndicatorView(style: .medium)
        restoreActivityIndicator.color = .appAccent
        view.insertSubview(restoreActivityIndicator, aboveSubview: tableView)
        restoreActivityIndicator.center = view.center
        restoreActivityIndicator.hidesWhenStopped = true
        
        StoreObserver.shared.finishedCallback = { [weak self] in
